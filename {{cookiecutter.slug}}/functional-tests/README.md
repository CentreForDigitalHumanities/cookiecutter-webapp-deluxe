# {{cookiecutter.project_title}} functional tests
...
Every test in this suite is a short, automated simulation of the interaction between a user and {{cookiecutter.project_title}}, written in Python. [Selenium][2] provides the programmable web browser interface while [pytest][1] provides administrative support in the form of configuration and fixtures.
